        ...
        <div className="flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full bg-[#161616] border border-[#2a2725] p-10 md:p-16 rounded-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 text-center mb-12">
              <p className="text-gold text-[10px] tracking-[5px] uppercase mb-4 font-bold">Welcome Back</p>
              <h2 className="text-4xl font-serif text-white tracking-tight">會員登入</h2>
            ...
            <div className="text-center mt-12 text-[10px] tracking-[2px] uppercase text-[#5a5650] relative z-10">
              還沒有帳號嗎？{" "}
              <Link href="/register" className="text-white hover:text-gold transition-colors underline underline-offset-4">
                立即註冊
              </Link>
            </div>
          </div>
