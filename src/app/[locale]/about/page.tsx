    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center container px-4">
          <p className="text-gold text-[10px] tracking-[5px] uppercase mb-6">The Soul Behind the Stitch</p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col items-start">
              <p className="text-gold text-[10px] tracking-[4px] uppercase mb-4">起源</p>
              <h2 className="text-4xl md:text-5xl font-serif font-light leading-tight mb-10 text-white">
                在指尖與布料之間<br />
                <span className="text-gold">尋找靈魂的溫度</span>
              </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="flex flex-col items-start lg:order-1 order-2">
              <p className="text-gold text-[10px] tracking-[4px] uppercase mb-4">極致工藝</p>
              <h2 className="text-4xl md:text-5xl font-serif font-light leading-tight mb-10 text-white">
                拒絕妥協的<br />
                <span className="text-gold">精確美學</span>
              </h2>
              <div className="text-[#9a958e] text-lg leading-loose tracking-wide space-y-8 font-light">
                <p>
      ...
      <section className="py-48 bg-[#0a0a0a] text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <p className="text-gold text-[10px] tracking-[4px] uppercase mb-6">未來願景</p>
