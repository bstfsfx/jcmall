    ...
    return (
      <div className="flex flex-col min-h-screen bg-[#0a0a0a]">
        <div className="container mx-auto px-6 py-32 text-center">
          <p className="text-[#5a5650] text-xl font-light italic mb-10">您的購物車目前是空的。</p>
          <Link href="/shop" className="inline-block bg-gold text-black px-12 py-5 text-[10px] font-bold tracking-[4px] uppercase hover:bg-gold-light transition-all duration-300">
            返回商店 / RETURN TO SHOP
          </Link>
        </div>
      </div>
    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0a]">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-16 reveal visible">
          <p className="text-gold text-[10px] tracking-[5px] uppercase mb-4 font-bold">Secure Checkout</p>
          <h1 className="text-5xl font-serif font-light text-white tracking-tight">結帳付款</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-20 pb-32">
          ...
          <div className="flex-grow space-y-12">
            ...
            <div className="flex gap-8 text-[10px] tracking-[3px] font-bold uppercase border-b border-white/5 pb-8">
              <span className={step >= 1 ? "text-white" : "text-[#5a5650]"}>01 聯絡資訊</span>
              <span className="text-[#2a2725]">/</span>
              <span className={step >= 2 ? "text-white" : "text-[#5a5650]"}>02 配送方式</span>
              <span className="text-[#2a2725]">/</span>
              <span className={step >= 3 ? "text-white" : "text-[#5a5650]"}>03 付款資訊</span>
            </div>

            {step === 1 && (
              <form onSubmit={handleNextStep} className="space-y-12 animate-[fadeIn_0.5s_forwards]">
                <div className="space-y-8">
                  <h2 className="text-2xl font-serif text-white">聯絡資訊 / Contact</h2>
                ...
                <div className="space-y-8">
                  <h2 className="text-2xl font-serif text-white pt-8">配送地址 / Shipping</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">名字 / First Name</label>
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">姓氏 / Last Name</label>
                  ...
                  <div className="flex flex-col gap-3">
                    <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">詳細地址 / Address</label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">城市 / City</label>
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">州/省 / State</label>
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">郵遞區號 / ZIP</label>
              ...
              <form onSubmit={handleNextStep} className="space-y-12 animate-[fadeIn_0.5s_forwards]">
                 <div className="bg-[#111111] border border-[#2a2725] p-8 rounded-sm space-y-6 text-[10px] tracking-[2px] uppercase font-bold">
                   <div className="flex justify-between items-center border-b border-white/5 pb-6">
                      <span className="text-[#5a5650]">聯絡資訊 / Contact</span>
                      <span className="text-white">user@example.com</span>
                      <button type="button" onClick={() => setStep(1)} className="text-gold hover:text-white transition-colors">修改 / Edit</button>
                   </div>
                   <div className="flex justify-between items-center">
                      <span className="text-[#5a5650]">配送至 / Ship to</span>
                 ...
                 <div className="space-y-8">
                   <h2 className="text-2xl font-serif text-white pt-8">配送方式 / Shipping Method</h2>
                   <div className="bg-[#161616] border border-gold p-8 flex justify-between items-center rounded-sm group cursor-pointer">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <p className="text-white text-[10px] tracking-[3px] font-bold uppercase">標準配送 / Standard Shipping</p>
                          <p className="text-[#5a5650] text-[9px] tracking-[2px] uppercase mt-1">3-5 個工作天 / Business Days</p>
                        </div>
                      </div>
            ...
            {step === 3 && (
              <form onSubmit={handlePayment} className="space-y-12 animate-[fadeIn_0.5s_forwards]">
                <div className="space-y-8">
                  <h2 className="text-2xl font-serif text-white">付款資訊 / Payment</h2>
                  <p className="text-[#5a5650] text-[10px] tracking-[2px] uppercase font-bold mb-8">所有交易皆經過加密處理，確保安全。</p>
                  
                  <div className="bg-[#111111] border border-[#2a2725] p-10 space-y-10 rounded-sm">
                    <div className="flex justify-between items-center pb-6 border-b border-white/5">
                       <span className="text-white text-[10px] tracking-[3px] font-bold uppercase">信用卡付款 / Credit Card</span>
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">卡號 / Card Number</label>
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">持卡人姓名 / Name on Card</label>
                    ...
                    <div className="grid grid-cols-2 gap-10">
                      <div className="flex flex-col gap-3">
                        <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">到期日 / Expiry (MM/YY)</label>
                      ...
                      <div className="flex flex-col gap-3">
                        <label className="text-[10px] tracking-[3px] uppercase font-bold text-white/40">安全碼 / CVV</label>
                ...
                <div className="flex gap-6 pt-10">
                   ...
                   <button type="submit" disabled={isProcessing} className="flex-1 bg-gold text-black py-6 text-[10px] font-bold tracking-[4px] uppercase hover:bg-gold-light transition-all shadow-2xl disabled:opacity-50">
                     {isProcessing ? <span className="animate-pulse">處理中... / PROCESSING</span> : '立即付款 / PAY NOW'}
                   </button>
                 </div>
              </form>
            )}
          ...
          <div className="lg:w-[400px] flex-shrink-0">
            <div className="bg-[#161616] border border-[#2a2725] p-10 rounded-sm sticky top-32">
              <h2 className="text-2xl font-serif text-white mb-10 pb-6 border-b border-white/5">訂單摘要 / Order Summary</h2>
              ...
              <div className="space-y-4 mb-10 pt-6 border-t border-white/5">
                ...
                <div className="flex justify-between text-[10px] tracking-[3px] uppercase font-bold">
                  ...
                  <span className="text-gold">{step > 1 ? 'FREE' : '計算中...'}</span>
                </div>
